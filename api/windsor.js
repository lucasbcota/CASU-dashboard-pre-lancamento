...
const QUERIES = {
  ...
  ga4_lp_daily: { source: 'googleanalytics4', account: 'GA4_ACCOUNT_LP_VIP',
    fields: ['date', 'sessions', 'totalusers', 'newusers', 'screenpageviews', 'engagedsessions', 'averagesessionduration', 'bouncerate'] },
  ga4_lp_source: { source: 'googleanalytics4', account: 'GA4_ACCOUNT_LP_VIP',
    fields: ['date', 'sessionsource', 'sessionmedium', 'sessioncampaignname', 'sessions', 'totalusers', 'screenpageviews'] },
  ga4_lp_geo: { source: 'googleanalytics4', account: 'GA4_ACCOUNT_LP_VIP', fields: ['date', 'city', 'region', 'sessions', 'totalusers'] },
  ga4_lp_device: { source: 'googleanalytics4', account: 'GA4_ACCOUNT_LP_VIP', fields: ['date', 'devicecategory', 'sessions', 'totalusers'] },
  ga4_ecomm_daily: { source: 'googleanalytics4', account: 'GA4_ACCOUNT_ECOMM',
    fields: ['date', 'sessions', 'totalusers', 'screenpageviews', 'addtocarts', 'checkouts', 'ecommercepurchases', 'purchaserevenue'] },
  ga4_ecomm_source: { source: 'googleanalytics4', account: 'GA4_ACCOUNT_ECOMM', fields: ['date', 'sessionsource', 'sessionmedium', 'sessions', 'ecommercepurchases', 'purchaserevenue'] },
